package kr.ac.kumoh.ce.com.s20190839.s23w06intent
...
import kr.ac.kumoh.ce.com.s20190839.s23w06intent.ui.theme.S23W06IntentTheme
...
fun Greeting(name: String, modifier: Modifier = Modifier) {
    ...
    Column {
        ...
        Button(
            modifier = modifier.fillMaxWidth(),
            onClick = {
                val uri = Uri.parse( "geo:36.145015,128.393047?z=17")
                val intent = Intent(Intent.ACTION_VIEW, uri)
                startActivity(context, intent, null)
            }
        ) {
        ...
        Button(
            modifier = modifier.fillMaxWidth(),
            onClick = {
                val uri = Uri.parse( "geo:0,0?q=경상북도 구미시")
                val intent = Intent(Intent.ACTION_VIEW, uri)
                startActivity(context, intent, null)
            }
        ) {
